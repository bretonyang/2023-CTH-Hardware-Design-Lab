...
set_property IOSTANDARD LVCMOS33 [get_ports {drop_juice}]
set_property IOSTANDARD LVCMOS33 [get_ports {drop_coffee}]
set_property PACKAGE_PIN E19 [get_ports {drop_juice}]
set_property PACKAGE_PIN U16 [get_ports {drop_coffee}]
